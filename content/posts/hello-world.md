...
- **Model updates**: When significant new models drop, I'll share practical takes on what matters
- **Technical deep dives**: Going beyond the Learn Guide with implementation details and experiments
- **Industry observations**: Thoughts on where AI is heading and what it means for builders
- **Project updates**: News about LMF projects and tools
